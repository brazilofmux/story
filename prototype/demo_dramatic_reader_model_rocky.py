...
Usage:
    ...
    .venv/bin/python3 demo_dramatic_reader_model_rocky.py

    # Dry run (no API call, prints the full prompt):
    .venv/bin/python3 demo_dramatic_reader_model_rocky.py --dry-run
...
from rocky import ENTITIES, FABULA
...
from rocky_dramatica_complete_verification import run as run_rocky_verifier
