...
Usage:
    ...
    .venv/bin/python3 -m demos.demo_dramatic_reader_model_rashomon

    # Dry run (no API call, prints full prompt):
    .venv/bin/python3 -m demos.demo_dramatic_reader_model_rashomon --dry-run
...
from story_engine.encodings.rashomon import ENTITIES, EVENTS_ALL
...
from story_engine.encodings.rashomon_lowerings import LOWERINGS
from story_engine.encodings.rashomon_dramatica_complete_verification import run as run_rashomon_verifier
