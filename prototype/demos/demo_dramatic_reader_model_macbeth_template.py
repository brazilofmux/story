...
Usage:
    ...
    .venv/bin/python3 -m demos.demo_dramatic_reader_model_macbeth_template

    # Dry run (no API call, prints the full prompt):
    .venv/bin/python3 -m demos.demo_dramatic_reader_model_macbeth_template --dry-run
...
from story_engine.encodings.macbeth_dramatica_complete_verification import run as run_verifier
