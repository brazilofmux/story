...
Usage:
    ...
    .venv/bin/python3 demo_dramatic_reader_model_macbeth.py

    # Dry run (no API call, prints the full prompt):
    .venv/bin/python3 demo_dramatic_reader_model_macbeth.py --dry-run
...
from macbeth_verification import run as run_macbeth_verifier
