...
from story_engine.encodings.rocky_dramatic import THROUGHLINES, CHARACTERS, STORY
...
def dsp_resolve_steadfast_trajectory_check(
    ...
    from story_engine.core.substrate import Prop, project_knowledge as _pk
...
def dsp_growth_start_trajectory_check(
    ...
    from story_engine.core.substrate import Prop  # local import to avoid cycle issues
    events_in_scope_all = [
        e for e in FABULA if in_scope(e, CANONICAL, ALL_BRANCHES)
    ]
