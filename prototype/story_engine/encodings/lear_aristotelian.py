...
AR_CORDELIA = ArCharacter(
    ...
    hamartia_text=(
        ...
        "Cordelia. The dialect lacks a way to mark 'tragic hero "
        "whose hamartia produces catastrophe for others but whose "
        "own arc does not contain a recognition moment' — banked "
        "as OQ-LEAR-3, surfaced by Session 5's probe run. Under "
        "Poetics A4 (1453a), Cordelia still qualifies as a tragic "
        "character on hamartia-plus-misfortune grounds; the "
        "recognition-requirement is a dialect-level encoding "
