...
from story_engine.encodings.macbeth_dramatic import THROUGHLINES, CHARACTERS, STORY
...
from story_engine.encodings.macbeth_dramatic import ARGUMENTS, SCENES, BEATS, STAKES
