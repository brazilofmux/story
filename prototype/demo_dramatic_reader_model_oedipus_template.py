...
Usage:
    ...
    .venv/bin/python3 demo_dramatic_reader_model_oedipus_template.py

    # Dry run (no API call, prints the full prompt):
    .venv/bin/python3 demo_dramatic_reader_model_oedipus_template.py --dry-run
...
from oedipus import ENTITIES, FABULA
...
from oedipus_dramatica_complete_verification import run as run_verifier
