...
Usage:
    ...
    .venv/bin/python3 demo_reader_model_macbeth.py
    ...
    .venv/bin/python3 demo_reader_model_macbeth.py --save-json reader_model_macbeth_output.json

    # Walk the probe's output interactively:
    .venv/bin/python3 demo_reader_model_macbeth.py --walk
"""
