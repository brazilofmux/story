...
Usage:
    ...
    .venv/bin/python3 demo_dramatic_reader_model_ackroyd_template.py

    # Dry run (no API call, prints the full prompt):
    .venv/bin/python3 demo_dramatic_reader_model_ackroyd_template.py --dry-run
...
from ackroyd import ENTITIES, FABULA
...
from ackroyd_dramatica_complete_verification import run as run_verifier
