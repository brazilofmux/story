...
def test_oedipus_dramatic_produces_expected_observations():
    ...
    import story_engine.encodings.oedipus_dramatic as o
    obs = verify(
        o.STORY,
...
def test_macbeth_dramatic_produces_zero_observations():
    ...
    """
    import story_engine.encodings.macbeth_dramatic as m
    obs = verify(
        m.STORY,
...
def test_story_encoding_wraps_multiple_stories():
    ...
    from story_engine.core.dramatic import StoryEncoding, StoryRelation, Story
...
def test_rashomon_encoding_loads_with_five_stories_ten_relations():
    ...
    import story_engine.encodings.rashomon_dramatic as r
