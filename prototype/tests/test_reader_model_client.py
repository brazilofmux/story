...
from story_engine.core.reader_model_client import (
    DroppedOutput,
    ReaderAnswer,
    ReaderEdit,
    ReaderOutput,
...
def _make_event_list() -> list:
    ...
    from story_engine.core.substrate import Event, CANONICAL_LABEL
...
def test_translate_review_produces_review_entry():
    ...
    from story_engine.core.substrate import ReviewVerdict
